...
#SBATCH --output=logs_abinitio/log_abinitio_10k_haddock_%j.out
#SBATCH --error=logs_abinitio/log_abinitio_10k_haddock_%j.err

BASE_DIR="data/haddock_units"
CONFIG_FILE="configs/config_abinitio.cfg"
